...
function help(message) {
    let helpEmbed = new MessageEmbed()
        ...
        .setDescription(`Commands are *not* case-sensitive. 
        ...
        .addFields(
            ...
            { name: '/create prepack gold# silver# DM', value: `This will prepack inventory with "crowbar, hammer, pitons x10, torches x10, rations x10, feet of hempen rope x100.
