    ...
    commands: [
        {
            ...
            explanation: `Use this command to modify your characters' stats. If you use the \`create\` command, all will be 10 by default.`
        },
        {
            name: '/d, /dice',
        ...
        {
            name: '/inventory, /inv',
            example: `Displays your own inventory.`
        },
        {
            name: '/add *category*',
        ...
        {
            name: '/dm',
            example: `**/dm on** will send all notifications from the bot to your DMs. **/dm off** will send them to the channel. Set explanation: individually per user. DMs are off by default.`
        },
        {
            name: '/overwrite',
        ...
        {
            name: '/deleteplayer',
            explanation: `Deletes your entire inventory and changelog. *Use with care!*`
        },
        {
            name: 'Money',
            explanation:
        ...
        {
            name: '/login',
            explanation: `You can login/register to view and edit your inventory on the IntelliDnD website: https://www.intellidnd.com/.`
        },
        {
            name: 'Support',
            explanation: `If you find a bug or have any suggestions for additional features, please submit a ticket at https://github.com/moojigc/DiscordBot/issues.`
        },
        {
            name: 'Your Data',
            explanation:
