export default {
    ...
    commands: [
        ...
        },
        {
            name: '/add *category*',
            explanation: [
                'Adds new items to specified category. Supports lists of items, and quantity, but not both at the same time.', 'e.g., `/add gold 50` adds 50 to gold, `/add potions Health 2` will add Health x2, and `/add potions Health, Poison` will add Health and Poison.'
            ]
        },
        {
            name: '/create',
